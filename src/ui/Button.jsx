...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    primary: base + 'px-4 py-3 md:px6 md:py-4',
    small: base + 'text-xs px-4 py-2 md:px-5 md:py-2.5',
    round: base + 'text-sm px-2.5 py-1 md:px-3.5 md:py-2',
    secondary:
      'inline-block rounded-full border-2 border-stone-300  font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:outline-none focus:ring focus:ring-stone-200 focus:text-stone-800 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px6 md:py-3.5 ',
  };
  if (to)
    return (
